...
#######################
   ...
   fp2cut1=Halfspace(Z,fPoint)
   rp2cut1=Halfspace(Z,rPoint)
   #fp2cut1.rotate(Segment(fPoint,X),-frontAngle)
   fp2cut2=Halfspace(-Z,fPointLower)
   rp2cut2=Halfspace(-Z,rPointLower)
   fp2cut2.rotate(Segment(fPointLower,X),-frontAngle)
   rp2cut2.rotate(Segment(rPointLower,X),rearAngle)
   fp2cut3=Halfspace(-Y,fcyl.point(.5,.5,.5))
   rp2cut3=Halfspace(Y,rcyl.point(.5,.5,.5))
