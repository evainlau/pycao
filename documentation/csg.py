...
cyl.amputed_by(cyl2,keepTexture=False,takeCopy=False)
wall.amputed_by(cyl,keepTexture=False,takeCopy=False)
...
wall.intersected_by([cyl3,cyl4],takeCopy=False)
...
#camera.actors=[wall]
camera.actors=[wall,cyl,cyl2,cyl3,cyl4]
